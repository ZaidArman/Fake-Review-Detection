...
const Footer = () => {
  const footerNavs = [
    {
      ...
      items: [
        {
          href: "/fakereviewanalyzer",
          name: "Fake Review Analyzer",
        },
      ],
    },
    {
  ...
  return (
    <footer className="pt-10 mt-32 bg-gray-100">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="justify-evenly sm:flex">
          <div className="space-y-6">
            <img src="" className="w-32" />
            <p className="max-w-md">
              Discover top-rated products on Daraz with our AI-powered tool.
              Enter a keyword to find authentic reviews and make informed
              purchasing decisions instantly.
            </p>
          </div>
          <div className="flex-1 mt-10 space-y-6 justify-evenly sm:flex md:space-y-0 md:mt-0">
        ...
        <div className="mt-10 py-10 border-t md:text-center">
          <p>© 2024 Shop Smart AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

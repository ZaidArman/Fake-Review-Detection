...
//     try {
//       const response = await axios.post("http://127.0.0.1:8000/api/accounts/password_reset/", {
...
//       // Save token and user info to local storage or state
//       localStorage.setItem("token", response.data.token);
//       localStorage.setItem("user", JSON.stringify(response.data));

//       // Redirect to another page after successful login
//        window.location.href = "/fakereviewanalyzer";
//       // navigateTo("/fakereviewanalyzer");
//     } catch (err) {
...
//             <div className="text-red-600">{forgotPasswordMessage}</div>
//           )}
//           <button className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150">
